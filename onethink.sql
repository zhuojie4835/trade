...
INSERT INTO `onethink_action_log` VALUES ('69', '1', '1', '3232243969', 'member', '1', 'admin在2017-01-24 18:10登录了后台', '1', '1485252650');
INSERT INTO `onethink_action_log` VALUES ('70', '1', '1', '3232243969', 'member', '1', 'admin在2017-01-26 17:24登录了后台', '1', '1485422678');
...
INSERT INTO `onethink_menu` VALUES ('140', '假期设置', '124', '5', 'settings/notrade', '0', '', '系统设置', '0', '1');
...
-- ----------------------------
INSERT INTO `trade_agent` VALUES ('7', '100003', '1', '500010', '100003', '0', '1', '0', '', '会员AA', '65.00', '65.00', '65.00', '', '1482992324', '0', '胡集', '0', '0', '0', '', '15212356856', '', '', '', '0', '', '', '', '1', '0', '1', '', '', '', '0', '', '', '1', '', '500010');
...
-- ----------------------------
DROP TABLE IF EXISTS `trade_notrade`;
CREATE TABLE `trade_notrade` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `datetime` int(11) NOT NULL DEFAULT '0' COMMENT '日期',
  `reason` varchar(256) NOT NULL DEFAULT '0' COMMENT '原因',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态',
  `admin_id` int(11) NOT NULL DEFAULT '0' COMMENT '后台人员id',
  `last_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='假期设置表';
...
CREATE TABLE `trade_position` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户持仓表';
...
CREATE TABLE `trade_settings` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='配置表';

-- ----------------------------
-- Records of trade_settings
-- ----------------------------
INSERT INTO `trade_settings` VALUES ('3', 'login_timeout', '1800', '1', '1', '1', '1485254203', '登录失效时间 单位秒');
...
INSERT INTO `trade_settings` VALUES ('11', 'trade_fee', '0.02', '2', '1', '1', '1485253605', '交易手续费 （最大值1）');
INSERT INTO `trade_settings` VALUES ('12', 'cancel_gd_time', '15:40', '2', '1', '1', '1485277423', '系统撤单时间 格式xx:xx');
