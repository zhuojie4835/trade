...
-- ----------------------------
INSERT INTO `onethink_member` VALUES ('1', 'admin', '0', '0000-00-00', '', '120', '29', '0', '1481298712', '3232243969', '1484805953', '1');
...
-- ----------------------------
INSERT INTO `onethink_ucenter_member` VALUES ('1', 'admin', 'e5edc271c5cb88af47aca190c1beaf50', 'zhuojie4835@163.com', '', '1481298712', '3232243969', '1484805953', '3232243969', '1481298712', '1');
...
CREATE TABLE `trade_agent` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='代理商表';
...
INSERT INTO `trade_agent` VALUES ('9', '100003', '3', '700010', '600010', '8', '8000001', '0', '7,8', '代理DD', '20.00', '20.00', '20.00', '', '1484542171', '0', '小忽悠', '0', '0', '0', '', '14856254865', '', '', '', '0', '', '', '', '1', '0', '1', '', '', '', '0', '', '', '1', '', '500010');
...
CREATE TABLE `trade_customer` (
  ...
  `agent_member_number` int(10) NOT NULL DEFAULT '0' COMMENT '所属会员编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8000003 DEFAULT CHARSET=utf8 COMMENT='客户表';

-- ----------------------------
-- Records of trade_customer
-- ----------------------------
INSERT INTO `trade_customer` VALUES ('8000001', '1', '18627540136', '38bf9e203296babf7225bc4087d6a429', '100003', '0', '500010', '0', '卓捷', '430821198912144835', '0', '0', '0.00', '1', '1', '0', '1', '1', '', '', '', '', '0', '0', '', '192.168.33.1', '', '', '0', '0', '1', '1484806008', '0', '1484826450', '500010');
INSERT INTO `trade_customer` VALUES ('8000002', '1', '18627540135', '38bf9e203296babf7225bc4087d6a429', '100003', '0', '500010', '0', 'amin', '430821198912144819', '0', '0', '0.00', '1', '1', '0', '1', '1', '', '', '', '', '0', '0', '', '192.168.33.1', '', '', '8000001', '0', '1', '1484808133', '0', '1484825448', '500010');
...
CREATE TABLE `trade_deals` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='成交记录';
...
-- ----------------------------
INSERT INTO `trade_position` VALUES ('1', '1', '650010', '艺术品A', '8000001', '卓捷', '18627540136', '500010', '200', '200', '100.00', '100.00', '1484826030', '2');
INSERT INTO `trade_position` VALUES ('2', '2', '600012', '版画敦煌', '8000001', '卓捷', '18627540136', '500010', '47', '47', '203.00', '199.81', '1484826030', '3');
INSERT INTO `trade_position` VALUES ('3', '2', '600012', '版画敦煌', '8000002', 'amin', '18627540135', '500010', '3', '3', '203.00', '203.00', '1484826030', '3');
